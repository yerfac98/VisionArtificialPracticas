...
-Crear un programa que lea una imagen y aplique procesamiento morfológico
a la imagen, tales como las operaciones: Erosión, Dilatación, Apertura y Cerradura.
Visualizar en una ventana la imagen original y las operaciones morfológicas aplicadas
(erosión, dilatación, apertura y cerradura).
'''
